...
exports.AuditResearchDto = void 0;
const class_validator_1 = require("class-validator");
const research_task_entity_1 = require("../entities/research-task.entity");
class AuditResearchDto {
}
exports.AuditResearchDto = AuditResearchDto;
__decorate([
    (0, class_validator_1.IsEnum)(research_task_entity_1.ResearchStatus),
    __metadata("design:type", String)
], AuditResearchDto.prototype, "status", void 0);
__decorate([
