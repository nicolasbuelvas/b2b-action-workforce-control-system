...
export default function SubAdminLinkedInInquiry(): JSX.Element {
  ...
  const tasksByCategory = tasks.reduce(
    ...
    {} as Record<string, LinkedInInquiryTask[]>,
  );
  ...
  return (
    <div className="website-research-container">
      <div className="website-research-header">
        <h1>📧 LinkedIn inquiry Tasks</h1>
        <p className="header-subtitle">
          View and manage all LinkedIn inquiry submissions for your assigned categories
        </p>
      </div>
      ...
      {loadState === 'loading' && (
        <div className="loading-container">
          ...
          <p>Loading LinkedIn inquiry tasks...</p>
        </div>
      )}
      ...
      {loadState === 'error' && (
        <div className="error-container">
          <p>❌ Failed to load LinkedIn inquiry tasks</p>
      ...
      {loadState === 'success' && tasks.length === 0 && (
        <div className="empty-state">
          <p>📭 No LinkedIn inquiry tasks found</p>
                  ...
                  <div key={task.id} className="task-card">
                    <div className="task-card-header">
                      <h3 className="task-company-name">
                        {task.profileName || task.profileUrl || 'LinkedIn inquiry'}
                      </h3>
                      <span
        ...
        <div className="modal-overlay" onClick={() => setSelectedTask(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>{selectedTask.profileName || selectedTask.profileUrl || 'LinkedIn inquiry'}</h2>
              <button 
