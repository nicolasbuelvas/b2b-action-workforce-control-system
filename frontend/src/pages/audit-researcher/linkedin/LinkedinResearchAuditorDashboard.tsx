...
import './LinkedinResearchAuditorDashboard.css';

export default function LinkedinResearchAuditorDashboard() {
  return (
    <div className="wb-audit-dash">
      {/* HEADER */}
      <header className="dash-header">
        <div className="welcome-text">
          <h1>LinkedIn Research Quality Assurance</h1>
          <p>Review and validate researcher submissions for LinkedIn profiles.</p>
        </div>
      </header>
